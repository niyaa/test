# -*- coding: utf-8 -*-
"""
Created on Fri Dec  4 16:49:42 2015
...
global V, invV;
global x, y, NODETOL, VX, VY, eps;

global cR, cS,cW,cN;
global cVm, cDr, cDs, cRx,cSx, cRy,cSy, cJ;
global cChol, cX, cY;
...
In = 0; Out = 1; Wall = 3; Far = 4; Cyl = 5; Dirichlet = 6; Neuman = 7; Slip = 8;
rk4a = [            0.0, \
